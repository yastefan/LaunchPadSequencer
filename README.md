...
<kbd><img align="left" src="Documentation/120bpm.gif" width="200"></kbd> The example on the left shows a four step sequence, which triggers the *GrandMA3Sequence* 1 and 9 in the first step and the *GrandMA3Sequence* 9 in the third step. Assuming on the *GrandMA3Sequence* 1 is the dimmer of moving heads and on the 9 a movement for these, then the heads light up in the first step with a movement and in the third without a movement.
